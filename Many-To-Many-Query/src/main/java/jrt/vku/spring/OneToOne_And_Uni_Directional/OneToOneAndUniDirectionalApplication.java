...
//			findTeacherWithCourse_LAZY_JoinFetch(teacherDao, courseDao, 5);
			// Thêm student và course vào csdl
//			createCourseAndStudent(courseDao, studentDao);
			// Tìm course
			findCourseAndStudent(courseDao, 10);
		};
	}
	
	private void findCourseAndStudent(CourseDao courseDao, int courseID) {
//		Course course = courseDao.findCourseById(courseID);
		Course course = courseDao.findCourseAndStudentByCourseId(courseID);
		System.out.println(course);
		
		
		// In ra sinh viên đã tham gia khóa học
